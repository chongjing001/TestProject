...
SECRET_KEY = 'a5^-ch6g#oz&^bi36+xcoc_59v%mt)7%ih1f+7)_##!e*+u%#$'
...
MIDDLEWARE = [
    ...
    # 'utils.middleware.TestMiddleware2',
...
LOGGING = {
    ...
    'simple': {'%(message)s'},
    # 接受日志，并交给名为console的处理handers去处理
    'loggers': {'': {'handlers': ['console'], 'level': 'INFO'}},
    # 处理日志
    'handlers': {'console': {'level': 'INFO', 'filename': '%s/sys.log' % LOG_PATH, 'formatter': 'default',
                             'class': 'logging.handlers.RotatingFileHandler', 'maxBytes': 5 * 1024 * 1024, }
                 }
}
